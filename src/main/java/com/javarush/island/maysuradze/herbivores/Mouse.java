...
public class Mouse extends Herbivores{
    ...
    public Mouse(int age,String gender, int health) {
        super(new HashMap<>(Map.ofEntries(
                        ...
                        new AbstractMap.SimpleEntry<>(Rabbit.class, 0f), new AbstractMap.SimpleEntry<>(Goat.class, 0f),
                        ...
                        new AbstractMap.SimpleEntry<>(Plants.class, 1f), new AbstractMap.SimpleEntry<>(Mouse.class, 0f)
                )), age,gender, health
        );
    }
}
