...
public class Sheep extends Herbivores {
    ...
    public Sheep(int age, String gender, int health  ) {
        super(new HashMap<>(Map.ofEntries(
                        ...
                        new AbstractMap.SimpleEntry<>(Boar.class, 0f), new AbstractMap.SimpleEntry<>(Buffalo.class, 0f),
                        new AbstractMap.SimpleEntry<>(Duck.class, 0f), new AbstractMap.SimpleEntry<>(Caterpillar.class, 0f),
                        new AbstractMap.SimpleEntry<>(Plants.class, 1f), new AbstractMap.SimpleEntry<>(Sheep.class, 0f)
                )), age, gender, health
        );
    }
}
