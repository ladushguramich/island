...
public class Boar extends Herbivores {
    ...
    public Boar(int age, String gender, int health) {
        super(new HashMap<>(Map.ofEntries(
                ...
                new AbstractMap.SimpleEntry<>(Rabbit.class, 0f), new AbstractMap.SimpleEntry<>(Mouse.class, 0.50f), new AbstractMap.SimpleEntry<>(Goat.class, 0f),
                new AbstractMap.SimpleEntry<>(Sheep.class, 0f), new AbstractMap.SimpleEntry<>(Buffalo.class, 0f),
                new AbstractMap.SimpleEntry<>(Duck.class, 0f), new AbstractMap.SimpleEntry<>(Caterpillar.class, 0.90f),
                new AbstractMap.SimpleEntry<>(Plants.class, 1f), new AbstractMap.SimpleEntry<>(Boar.class, 0f)
        )), age, gender, health);
    }
}
