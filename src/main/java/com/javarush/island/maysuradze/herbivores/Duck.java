...
public class Duck extends Herbivores{
    ...
    public Duck(int age,String gender, int health) {
        super(new HashMap<>(Map.ofEntries(
                ...
                new AbstractMap.SimpleEntry<>(Caterpillar.class, 0.90f),
                new AbstractMap.SimpleEntry<>(Plants.class, 1f), new AbstractMap.SimpleEntry<>(Duck.class, 0f)
        )),age, gender, health);
    }
}
